...
const ShipmentMockData = () => {
  ...
  return {
    ShipmentReference: {
      RefOwner: 'Seller',
      RefID: 'Ref1234',
      RefTimestampUpdate: '1234567673242',
    },
    ...
    ShipmentMember: [
      { UserKey: 'User1', Premission: 'ShipmentOwner' },
      { UserKey: 'User2', Premission: 'ShipmentOwner' },
      { UserKey: 'User3', Premission: 'See Only' },
    ],
  };
};
  ...
  ChatRoomFileLink: [
    {
      ...
      FileCreateTimestamp: '123123124124124',
      FilePath: '/Shipment/{ShipmentKey}/ShipmentFile/{FileKey}',
    },
  ],
  ChatRoomMember: {},
  ChatRoomParticipleNotificationToken: [],
  ChatRoomhareDataList: ['Shipper', 'ShipmentDetail'],
  ChatRoomPrivateShareDataList: ['Trucking'],
});

const ChatRoomRefPath = ShipmentKey => FirebaseApp.firestore()
  .collection('Shipment')
  .doc(ShipmentKey)
  .collection('ChatRoom');

export const CreateChatRoom = ShipmentKey => ChatRoomRefPath(ShipmentKey).add(ChatRoomMockData());

const ChatRoomPrivateShareDataMockData = () => ({});

const ChatRoomPrivateShareDataRefPath = (ShipmentKey, ChatRoomKey, GroupName) => FirebaseApp.firestore()
  .collection('Shipment')
  .doc(ShipmentKey)
  .collection('ChatRoom')
  .doc(ChatRoomKey)
...
export const CreateChatRoomPrivateShareData = (ShipmentKey, ChatRoomKey, GroupName) => ChatRoomPrivateShareDataRefPath(ShipmentKey, ChatRoomKey, GroupName).set(
  ChatRoomPrivateShareDataMockData(),
  { merge: true },
);
...
const UserInfoMockData = () => {
  ...
  return {
    ...
    UserInfoProfileImageLink:
      'https://firebasestorage.googleapis.com/v0/b/yterminal-b0906.appspot.com/o/%E0%B8%A0%E0%B8%B2%E0%B8%9E%E0%B8%AB%E0%B8%99%E0%B9%89%E0%B8%B2%E0%B8%88%E0%B8%AD%202562-01-01%20%E0%B9%80%E0%B8%A7%E0%B8%A5%E0%B8%B2%2023.44.49.png?alt=media&token=6e105bbe-3cac-42dc-a166-590d5f23aff5',
...
export const CreateUserInfo = () => UserInfoRefPath().add(UserInfoMockData());
...
export const CreateCompany = () => CompanyRefPath().add(CompanyMockData());
...
export const CreateProfile = UserInfoKey => ProfileRefPath(UserInfoKey).add(ProfileMockData());
...
const ShipmentShareListMockData = () => ({
  ShipmentShareList: ['Shipper', 'ShipmentDetail', 'Consignee'],
});
...
const ShipmentShareDataRefPath = (ShipmentKey, GroupName) => FirebaseApp.firestore()
  .collection('Shipment')
  .doc(ShipmentKey)
...
const UserInvitationMockData = () => ({
  CompanyInvitationReference: FirebaseApp.firestore()
    .collection('Company')
    .doc('CompanyKey'),
...
const UserInvitationRefPath = UserInfoKey => FirebaseApp.firestore()
  .collection('UserInfo')
  .doc(UserInfoKey)
...
const UserRequestMockData = () => ({
  CompanyRequestReference: FirebaseApp.firestore()
    .collection('Company')
    .doc('CompanyKey'),
...
const UserRequestRefPath = UserInfoKey => FirebaseApp.firestore()
  .collection('UserInfo')
  .doc(UserInfoKey)
...
const UserShipmentMockData = ShipmentKey => ({
  UserShipmentReference: FirebaseApp.firestore()
    .collection('Shipment')
    .doc(ShipmentKey),
  UserShipmentTimestamp: new Date(),
});

const UserShipmentRefPath = UserInfoKey => FirebaseApp.firestore()
  .collection('UserInfo')
  .doc(UserInfoKey)
  .collection('UserShipment');
...
const UserChatRoomMockData = (ShipmentKey, ChatRoomKey) => ({
  UserChatRoomReference: FirebaseApp.firestore()
    .collection('Shipment')
    .doc(ShipmentKey)
    .collection('ChatRoom')
    .doc(ChatRoomKey),
...
const UserChatRoomRefPath = UserInfoKey => FirebaseApp.firestore()
  .collection('UserInfo')
  .doc(UserInfoKey)
...
const CompanyInvitationMockData = UserInfoKey => ({
  UserInvitationReference: FirebaseApp.firestore()
    .collection('UserInfo')
    .doc(UserInfoKey),
...
const CompanyRequestMockData = (CompanyKey, UserInfoKey) => ({
  UserRequestReference: FirebaseApp.firestore()
    .collection('UserInfo')
    .doc(UserInfoKey),
...
const CompanyUserMatrixRefPath = CompanyKey => FirebaseApp.firestore()
  .collection('Company')
  .doc(CompanyKey)
...
const UserPersonalizeShipmentOrderingRefPath = (ProfileKey, ShipmentKey) => FirebaseApp.firestore()
  .collection('UserPersonalize')
  .doc(ProfileKey)
  .collection('ShipmentOrdering')
  .doc(ShipmentKey);

export const CreateUserPersonalizeShipmentOrdering = (ProfileKey, ShipmentKey) => UserPersonalizeShipmentOrderingRefPath(ProfileKey, ShipmentKey).set(
  UserPersonalizeShipmentOrderingMockData(),
);
...
const UserPersonalizeShipmentPinRefPath = (ProfileKey, ShipmentKey) => FirebaseApp.firestore()
  .collection('UserPersonalize')
  .doc(ProfileKey)
  .collection('ShipmentPin')
  .doc(ShipmentKey);

export const CreateUserPersonalizeShipmentPin = (ProfileKey, ShipmentKey) => UserPersonalizeShipmentPinRefPath(ProfileKey, ShipmentKey).set(
  UserPersonalizeShipmentPinMockData(ShipmentKey),
);
...
const UserPersonalizeShipmentReferenceDisplayRefPath = (ProfileKey, ShipmentKey) => FirebaseApp.firestore()
  .collection('UserPersonalize')
  .doc(ProfileKey)
  .collection('ShipmentReferenceDisplay')
  .doc(ShipmentKey);

export const CreateUserPersonalizeShipmentReferenceDisplay = (ProfileKey, ShipmentKey) => UserPersonalizeShipmentReferenceDisplayRefPath(ProfileKey, ShipmentKey).set(
  UserPersonalizeShipmentReferenceDisplayMockData(),
);
