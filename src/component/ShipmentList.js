            ...
            >
              ...
              <ListGroupItem tag="a" style={{ borderBottom: 0 }}>
                <Row style={{ float: 'right' }}>
                  <Col>
                    <Button
                      ...
                      onClick={() =>
                        masterDetailModalRef.current.triggerMasterDetail(
                          data,
                ...
                <Row>
                  ...
                  <Col xs="10" className="master-detail-col-panel first">
                    ...
                    <b>
                      ...
                      data.ShipperCompanyName === undefined ? (
                ...
                <Row>
                  <Col xs="2">
                    <i
                      className="cui-location-pin"
                      style={{ fontSize: '30px' }}
                    />
                  </Col>
                  <Col xs="10" className="master-detail-col-panel">
                    {data.ShipperPort === undefined ||
                    data.ShipperPort === '' ? (
                    ...
                    <b>
                      ...
                      data.ShipperETDDate === undefined ||
                      data.ShipperETDDate === '' ? (
                        <span style={{ color: '#B3B3B3' }}>
                          Est. Time of Departure from Port
                        </span>
                      ) : (
                        `Port ETD: ${moment(
                          data.ShipperETDDate.seconds * 1000,
                        ).format('DD MMM YYYY')}`
                      )}
                    </b>
                  </Col>
                ...
                <Row>
                  ...
                  <Col xs="10" className="master-detail-col-panel">
                    ...
                    {' , '}
                    {data.ConsigneeCountry === undefined ||
                    ...
                    <b>
                      ...
                      data.ConsigneeETAPortDate === undefined ||
                      data.ConsigneeETAPortDate === '' ? (
                        <span style={{ color: '#B3B3B3' }}>
                          Est. Time of Arrive to Port
                        </span>
                      ) : (
                        `Port ETA: ${moment(
                    ...
                    <b>
                      ...
                      data.ConsigneeETAWarehouseDate === '' ? (
                        <span style={{ color: '#B3B3B3' }}>
                          Est. Time of Arrive to Warehouse
                        </span>
                      ) : (
              ...
              <ListGroupItem disabled tag="a">
                <Row>
                  ...
                  <Col xs="6" className="text-right">
                    {data.ShipmentDetailProduct === undefined ||
